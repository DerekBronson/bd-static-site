...
class TestTextImageLinkSplit(unittest.TestCase):
    def test_split_double_images(self):
        node = TextNode(
...
class TestTextConvertTextToNodes(unittest.TestCase):
    def test_convert_text_with_everything(self):
